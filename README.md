...
> [!NOTE]
> 首选项中可以调整在画布中新建 / 选中标记时是否自动聚焦到文本框，以获得与 [LabelPlus](https://github.com/LabelPlus/LabelPlus) / [LabelPlusFX](https://github.com/Meodinger/LabelPlusFX) 相似的体验

### 自由连字渲染与快速输入
LabelAva 支持对标记列表与输入文本框应用支持自由连字特性的字体，并自定义连字快捷输入规则。`/dlig_conf` 文件夹中存放了一些示例文件。
...
```bash
git clone https://github.com/Boxkun/LabelAva && cd LabelAva
